...
public class MultiImageSelectorActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(com.lzh.testwb.R.style.dialogActivity);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        int orientation = this.getResources().getConfiguration().orientation;
        setContentView(com.lzh.testwb.R.layout.activity_image_selector);
        ...
        Toolbar toolbar = (Toolbar) findViewById(com.lzh.testwb.R.id.toolbar);
        ...
        //多选模式下的提交按钮
        mSubmitButton = (Button) findViewById(com.lzh.testwb.R.id.commit);
        if (mode == MODE_MULTI) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(com.lzh.testwb.R.id.image_grid, Fragment.instantiate(this, MultiImageSelectorFragment.class.getName(), bundle))
                    .commit();
        }
...
//        setActivitySize(orientation);
    ...
    private void updateDoneText(ArrayList<String> resultList) {
        int size = 0;
        if (resultList == null || resultList.size() <= 0) {
            mSubmitButton.setText(com.lzh.testwb.R.string.action_done);
            mSubmitButton.setEnabled(false);
        } else {
            size = resultList.size();
            mSubmitButton.setEnabled(true);
        }
        mSubmitButton.setText(getString(com.lzh.testwb.R.string.action_button_string,
                getString(com.lzh.testwb.R.string.action_done), size, mDefaultCount));
    }
